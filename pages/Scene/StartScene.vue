...
<template>
  <div class="init-view" :style="{'padding-top':`${uniMenuPos.bottom}px`}">
    <!-- <div class="statusbar" :style="{height:`${uniMenuPos.bottom}px`}"></div>
    <div class="statusbar" :style="{height:`${uniMenuPos.top}px`}" style="background:#0f0"></div>-->
    <div
      class="uni-menu-button setting-btn"
      :style="{width:`${uniMenuPos.height}px`,height:`${uniMenuPos.height}px`,top:`${uniMenuPos.top}px`,left:`${uniMenuPos.marginSide}px`}"
      @click="showSetting"
    ...
    <div class="piece-box">
      ...
      >
        <div class="piece" hover-class="hover" :hover-start-time="0">
          ...
          <div class="number">{{restTimeSec | secToTimeStr}}</div>
        </div>
      </picker>
    </div>
    ...
    <div class="bottom-box" :class="{'pd-bt-40':isIphoneX}">
      <div class="tip-ct">
        <div class="tip show">
          共
          <span>{{totalSec | secToTimeStr}}</span>
        </div>
      </div>
      <div
        id="uni-report-start-run"
...
export default {
  ...
  methods: {
    ...
    restTimeChange(e) {
      ...
      console.log(this.restTimeIndex)
